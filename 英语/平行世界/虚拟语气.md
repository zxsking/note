...
真是过去: Tom said, "if it rains tomorrow, I will not go shopping"	(直接引语)
...
wish:
    ...
    I wish I where five centimeter taller. (对现在的虚拟)
...
would rather:
	I would rather you came here tomorrow (与现在事实相反)
	I would rather I hadn't seen the film.  (与过去事实相反)    
```
...
```
it is/was (adj./v.+ed/抽象) + that + sb. + (should) do 
```
